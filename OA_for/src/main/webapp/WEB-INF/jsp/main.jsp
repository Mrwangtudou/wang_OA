    ...
    <div class="container">
           ...
           <div class="pf-logo"">
            ...
            <div class="pf-user">
                <div class="pf-user-photo">
                    <img style="width: 40px;height: 40px;" src="${ctx}/images/main/xiaoqiang.png" alt="">
                </div>
        ...
        <div id="pf-bd">
            <div id="pf-sider">
                ...
                <ul class="sider-nav" id="sider-nav">
                    ...
                    <c:forEach items="${operasModules}" var="operasModule">
                       <li>
					    <a href="javascript:;"> <span
							class="iconfont sider-nav-icon">&#xe611;</span> <span
							class="sider-nav-title">${operasModule.key.name}</span> <i
							class="iconfont">&#xe642;</i>
					    </a>
					  
					    <ul class="sider-nav-s">
							<c:forEach items="${operasModule.value}" var="seModule">
							   	<li><a href="javascript:addPanel('${seModule.code}' ,'${seModule.url}','${seModule.name}');">${seModule.name}</a></li>
							</c:forEach>
					    </ul>
        ...
        <div id="pf-ft">
            ...
            <div class="copyright-name">
              <span>Copyright&nbsp;©&nbsp;2017&nbsp;-&nbsp;2019&nbsp;没有最好，只有更好&nbsp;版权所有</span>
              <i class="iconfont" >&#xe6ff;</i>
            </div>
        </div>
    </div>
